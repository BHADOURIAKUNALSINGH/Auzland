...
class AIService {
  constructor() {
    this.openai = new OpenAI({
      apiKey: process.env.DEEPINFRA_API_KEY || "GG6cBsIY54h7PYIdginIuC2MsFlZafeg",
    ...
    this.systemPrompt = `You are AUZ, the property filter assistant for AuzLand Real Estate.  
...
`;
  ...
  async generateFilterResponse(userMessage, conversationHistory = [], currentFilters = {}) {
    try {
